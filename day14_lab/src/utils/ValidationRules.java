...
public class ValidationRules {
	...
	//validateCustomerInputs(customers, sc.next(), sc.next(), sc.next(),
	//sc.nextDouble(), sc.next(), sc.next())
	public static Customer validateCustomerInputs(ArrayList<Customer> custList,String name, String email, 
			String password,double regAmount ,String dob, String plan)
